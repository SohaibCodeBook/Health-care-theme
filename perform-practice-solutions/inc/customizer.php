...
function pps_home_defaults() {
	return array(
		...
		'services_lead'           => 'Our medical practice management services are designed for physical therapy, chiropractic, occupational therapy, speech therapy, and specialty medical practices across the country. Each service works independently or as part of a fully integrated system.',
		...
		'service_4_text'          => 'Free your team from repetitive administrative work. We build custom automation for scheduling, intake, reminders, and reporting, integrated directly with your EMR.',
		...
		'service_6_text'          => 'Our CEO, Kevin Rausch, works directly with owners to build the systems, dashboards, and team accountability behind a practice that grows even when the owner steps away.',
		'service_6_url'           => '/about-us/',
		'service_6_icon'          => 'fa-solid fa-chalkboard-user',

		'about_eyebrow'           => 'Who We Are',
		'about_title'             => 'Practice Management Services Is Built by People Who Have Actually Run a Practice',
		'about_text'              => 'Perform Practice Solutions was built for practice owners who are tired of losing time to administrative work that has nothing to do with patient care. We handle the industry specific challenges of billing, credentialing, marketing, staffing, and eligibility verification so you can run a more efficient, less stressful business.',
		'about_text_2'            => 'We are not a generic outsourcing firm. Our team understands the operational realities of physical therapy, chiropractic, occupational therapy, and speech therapy practices because we have worked inside them, typically supporting owners running 2 to 10 or more providers.',
		'about_cta'               => 'See If We\'re a Fit for Your Practice',
		'about_cta_url'           => '#providers',
		...
		'help_text'               => 'Switching EMR systems is one of the riskiest windows for collections to dip, and it\'s exactly where a lot of practices lose visibility. As part of our medical practice management services, we help clients baseline A/R days, denial rate, and clean claim percentage before go live, then run daily charge reconciliation and rejection review for the first two weeks after cutover so revenue stays on track.',
		'help_note'               => 'We also confirm payer enrollment, fee schedule mapping, and clearinghouse connections ahead of time so nothing stalls at the worst possible moment.',
		...
		'auto_lead'               => 'Every practice depends on recurring tasks: scheduling, reminders, intake, authorization, follow up, and reporting. Handled manually, these tasks eat up hours your team could spend with patients.',
		'auto_text'               => 'Perform Practice Solutions builds custom, AI powered automation designed around how your practice actually operates. Every system integrates directly with your EMR and scales as your practice grows. No generic software. No one size fits all tools. Just automation built for your workflows, with results you can measure from day one.',
		...
		'auto_1_cta'              => 'Explore Phone & Text',
		'auto_1_url'              => '/ai-development/phone-text-system/',
		...
		'auto_2_cta'              => 'Explore Referral Outreach',
		'auto_2_url'              => '/ai-development/referral-outreach/',
		'auto_3_title'            => 'Website Chatbots',
		'auto_3_text'             => 'Integrated chatbots that answer questions and capture leads around the clock.',
		'auto_3_cta'              => 'Explore Website Chatbots',
		'auto_3_url'              => '/ai-development/website-chatbot/',
		...
		'auto_4_cta'              => 'Explore Front Desk Tools',
		'auto_4_url'              => '/ai-development/front-desk-tools/',
		...
		'founder_text'            => 'Running a successful practice takes more than clinical skill. Our CEO, Kevin Rausch, works directly with owners to build the systems, dashboards, and team accountability behind a practice that grows and profits even when the owner steps away. Bi-monthly coaching sessions use a real time metrics dashboard to replace guesswork with data driven decisions.',
		...
		'stats_lead'              => 'Every unresolved claim, missed credential renewal, or inefficient front desk process is money your practice has already earned and simply isn\'t collecting. Our medical practice management services are built to close that gap.',
		'stat_1_value'            => '15%',
		'stat_1_label'            => 'of submitted claims are denied, creating unnecessary revenue uncertainty.',
		'stat_2_value'            => '65%',
		'stat_2_label'            => 'of denied claims are never resolved, which means that revenue is gone for good.',
		'stat_3_value'            => '10–15%',
		'stat_3_label'            => 'of total practice revenue is typically recoverable with proper follow up and the right billing partner.',
		'stats_cta'               => 'Find Out What You\'re Missing',
		'stats_cta_url'           => '#contact',

		'providers_eyebrow'       => 'Who We Support',
		'providers_title'         => 'Types of Providers and Facilities We Support',
		'providers_lead'          => 'Our medical practice management services flex to fit the size and structure of your organization, from a single provider office to a multi-site group.',
		'providers_text'          => 'Whether you\'re a solo practitioner trying to stay out of the billing weeds or a multi-site group coordinating credentialing across a dozen providers, we scale our staffing, reporting, and automation to match how your organization actually operates.',
		'providers_cta'           => 'See If We\'re a Fit for Your Practice',
		'providers_cta_url'       => '#contact',
		'providers_1'             => 'Solo clinics and small size practices',
		'providers_2'             => 'Multi specialty groups, large hospitals, and health systems',
		'providers_3'             => 'Medical billing companies',
		'providers_4'             => 'Outpatient surgery centers',
		'providers_5'             => 'Nursing homes and assisted living facilities',
		'providers_6'             => 'Laboratories',

		'support_eyebrow'         => 'Practice Support',
		'support_title'           => 'Get the Support Your Practice Deserves, Without the Hassle',
		'support_text'            => 'Running a healthcare practice shouldn\'t feel like constantly putting out fires. Perform Practice Solutions simplifies the toughest parts of practice management so you can focus on what matters most, taking care of your patients.',
		'support_cta'             => 'Book a Growth Session',
		'support_cta_url'         => '#contact',
		'support_q1'              => 'Billing and collections that move cash faster',
		'support_q2'              => 'Credentialing that keeps you in-network',
		'support_q3'              => 'Virtual staffing that frees your front desk',
		'support_q4'              => 'AI automation built around your workflows',
		'support_q5'              => 'Marketing that attracts the right patients',
		'support_q6'              => 'Coaching that builds accountable systems',
		...
		'contact_eyebrow'         => 'Flexible Packages',
		'contact_title'           => 'Flexible Packages Built Around Your Practice',
		'contact_lead'            => 'Whether you need one service or a fully outsourced back office, our pricing scales with you. Billing runs as a percentage of monthly collections rather than a flat fee, so we\'re only successful when your practice is. Credentialing, virtual staffing, AI automation, and marketing are available individually or bundled into a comprehensive management package for owners who want a single point of accountability across their entire operation.',
...
function pps_customize_register( $wp_customize ) {
	...
	$sections = array(
		...
		'intro'     => __( 'Intro', 'perform-practice' ),
		...
		'providers' => __( 'Providers', 'perform-practice' ),
